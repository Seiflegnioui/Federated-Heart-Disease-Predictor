...
\setbeamertemplate{footline}{
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=west, font=\scriptsize, text=fgWhite] at ([xshift=0.5cm, yshift=0.3cm]current page.south west) {S. \textsc{Legnioui}, Y. \textsc{Sarraf}, B. \textsc{Mertaj}, M.Y. \textsc{Rachih}, A. \textsc{Chmarkh} \quad $\vert$ \quad Optimisation};
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=center, align=center] at (current page.center) {
        ...
        \color{titleWhite}\normalsize S. \textsc{Legnioui}, Y. \textsc{Sarraf}, B. \textsc{Mertaj}, M.Y. \textsc{Rachih}, A. \textsc{Chmarkh} \\[0.2cm]
        \color{fgWhite}\normalsize Encadr\'{e} par : Pr. Faouzia \textsc{Benabbou} \\[0.4cm]
...
\begin{frame}{R\'{e}partition IID : Le Monde Id\'{e}al}
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{images/class_dist_iid.png}
...
\begin{frame}{R\'{e}partition Non-IID : Le Monde R\'{e}el}
  \begin{columns}
    ...
    \begin{column}{0.45\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{images/class_dist_noniid.png}
...
\begin{frame}{R\'{e}sultats : Convergence (Loss \& Accuracy)}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{images/loss_convergence.png}
        \caption{\color{fgWhite}\footnotesize \'{E}volution de la Perte (Loss)}
      \end{figure}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{images/accuracy_convergence.png}
        \caption{\color{fgWhite}\footnotesize \'{E}volution de la Pr\'{e}cision (Accuracy)}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
